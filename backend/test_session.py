...
async def main():
    ...
    browser_config = BrowserConfig(
        headless=False,  # Run in headful mode to bypass Cloudflare
    ...
    session_id = "indeed_scrape_session"
    
    async with AsyncWebCrawler(config=browser_config) as crawler:
        # 1. Fetch Page 1
        url1 = "https://pk.indeed.com/jobs?q=Python&fromage=7&start=0"
        ...
        # 2. Fetch Page 2
        url2 = "https://pk.indeed.com/jobs?q=Python&fromage=7&start=10"
